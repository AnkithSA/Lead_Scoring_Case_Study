...
- Lead_scoring_Case_Study.ipnb : The python file showing coding and data analysis
- Lead_scoring_Case_Study-Subjective Questions.pdf : Some subjective questions answered
- Lead_scoring_Case_Study-Presentation.pdf : Final Presentation
- Leads.csv : Data worked on
- Leads Data Dictionary.xlsx : Data Dictionary
- Lead_scoring_Case_Study-Brief Summary.pdf : Summary on what's done in the entire py file
